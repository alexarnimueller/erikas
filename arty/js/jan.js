...
//	fillColor: 'white'
//});
var circle = new Path('M178.575,87.155l296.707-38.228 c14.202-6.875,43.023,6.319,44.371,25.73c1.348,19.412-24.963,39.279-37.56,33.48l-0.624-0.335L233.812,139.71h1 c0,43.821-20.554,105.489-49.501,105.489c-28.947,0-52.413-35.525-52.413-79.347c0-43.822,23.466-79.347,52.413-79.347');
circle.strokeColor = 'white';
circle.fillColor = 'white';

var textErika = new PointText({
	point: view.center + (0, 2),
//	justification: 'center',
	fontSize: 25,
	rotation: -7,
	fontWeight: 'bold',
	content: '   happy birthday Jan!\n\n\n',
	fillColor: 'black'
});
...
function onResize(event) {
	...
	textErika.position = view.center;
}
